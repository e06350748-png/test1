          ...
          <div>
            <label className="form-control w-full max-w-xs">
              <div className="label">
                ...
                <span className="text-base">  </span>
                <span className="text-base"> {order?.lastname} </span>
              </div>
            </label>
          </div>
        </div>
        ...
        <div>
          <label className="form-control w-full max-w-xs">
            <div className="label">
              ...
              <span className="text-base"> {order?.phone} </span>
            </div>
          </label>
        </div>
        ...
        <div>
          <label className="form-control w-full max-w-xs">
            <div className="label">
              ...
              <span className="text-base"> {order?.email} </span>
            </div>
          </label>
        </div>
          ...
          <div>
            <label className="form-control w-full max-w-xs">
              <div className="label">
                ...
                <span className="text-base"> {order?.adress} </span>
              </div>
              <input
                type="text"
                className="input input-bordered w-full max-w-xs"
        ...
        <div>
          <label className="form-control">
            <div className="label">
              ...
              <span className="text-base"> {order?.orderNotice} </span>
